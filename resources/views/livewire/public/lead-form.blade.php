<div class="relative space-y-8">
    ...
    <div wire:loading.flex wire:target="submit"
         class="absolute inset-0 z-20 items-center justify-center bg-slate/80 backdrop-blur-sm rounded-2xl">
    ...
    <div class="space-y-8">
        ...
        <form wire:submit.prevent="submit" class="space-y-8">
            ...
            <div class="grid md:grid-cols-2 gap-5">
                <div>
                    ...
                    <input type="text" wire:model.defer="name" required
                           class="text-[#1e293b]/90 w-full rounded-lg border border-bp-gray-200 px-4 py-3 bp-focus"
                           autocomplete="name">
                ...
                <div>
                    ...
                    <div class="grid grid-cols-3 gap-3">
                        <select wire:model.defer="phone_country"
                                class="text-[#1e293b]/90 col-span-1 rounded-lg border border-bp-gray-200 px-3 py-3 bp-focus">
                        ...
                        <input type="tel" wire:model.defer="phone_national" required
                               class="text-[#1e293b]/90 col-span-2 rounded-lg border border-bp-gray-200 px-4 py-3 bp-focus"
                               inputmode="tel" placeholder="e.g. 83 123 4567">
                    </div>

                    <p class="mt-2 text-xs text-bp-gray-400">We’ll format your number automatically.</p>

                    @error('phone_country') <p class="text-[#1e293b]/90 mt-1 text-xs text-bp-red">{{ $message }}</p> @enderror
                    @error('phone_national') <p class="text-[#1e293b]/90 mt-1 text-xs text-bp-red">{{ $message }}</p> @enderror
                </div>
            ...
            <button type="submit"
                    ...
                    wire:target="submit"
                    class="bg-[#1e293b] hover:bg-[#8a0000] text-white w-full rounded-lg bg-bp-black hover:bg-bp-gray-900 text-white font-semibold py-3 transition disabled:opacity-60 disabled:cursor-not-allowed">
